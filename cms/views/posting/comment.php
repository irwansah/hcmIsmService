...
<input type="hidden" id="url-posting-data" value="<?= Url::to(['posting/index-comment']) ?>"/>
<input type="hidden" id="url-filter-data" value="<?= Url::to(['posting/filterdate-comment']) ?>"/>

<?php $param=Yii::$app->request->csrfParam; ?>
<?php $token=Yii::$app->request->csrfToken; ?>

<div id="loader" style="display:block;"></div>
<div id="posting-comment">
