...
<input type="hidden" id="url-posting-data" value="<?= Url::to(['posting/index-like']) ?>"/>
<input type="hidden" id="url-filter-data" value="<?= Url::to(['posting/filterdate-like']) ?>"/>
