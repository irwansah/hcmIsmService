...
<input type="hidden" id="url-posting-data" value="<?= Url::to(['posting/index-view']) ?>"/>
<input type="hidden" id="url-filter-data" value="<?= Url::to(['posting/filterdate-view']) ?>"/>
