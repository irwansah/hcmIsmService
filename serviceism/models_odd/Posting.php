    ...
    public function rules()
    {
        return [
            [['created_at', 'updated_at'], 'safe'],
   			[['group_name','owner_name','caption','url_content','thumnail_content','text'],'string'],
   			[['id_group','owner_id','active', 'like_count','views_count','comment_count','type_posting'], 'integer'],
        ];
    }
